...
id: virtual_printer_settings
title: Virtual Printer Settings
description: Adds configurable settings to the Virtual Printer plugin in OctoPrint's settings panel
author: Charlie
license: AGPLv3
...
http://plugins.octoprint.org/plugin/virtual_printer_settings/
